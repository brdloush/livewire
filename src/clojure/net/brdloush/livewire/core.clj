...
;;; ---------------------------------------------------------------------------
;;; Security (stub — implemented in a later iteration)

(defmacro run-as
  "Runs body with the given UserDetails set as the Spring Security principal.
   Restores the original SecurityContext afterwards.
   (Not yet implemented — coming in a later iteration.)"
  [_user-details & _body]
  `(throw (UnsupportedOperationException. "run-as not yet implemented")))
